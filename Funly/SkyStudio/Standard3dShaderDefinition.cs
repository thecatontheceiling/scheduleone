	...
	protected override ProfileGroupSection[] ProfileDefinitionTable()
	{
		return new ProfileGroupSection[12]
		{
			...
			new ProfileGroupSection("Clouds", "CloudSectionKey", "CloudSectionIcon", "CloudFeature", dependsOnValue: true, new ProfileGroupDefinition[30]
			{
				...
				ProfileGroupDefinition.NumberGroupDefinition("Cloud Direction", "CloudDirectionKey", 0f, MathF.PI * 2f, 1f, "NoiseCloudFeature", dependsOnValue: true, "Direction that the clouds move in as an angle in radians between 0 and 2PI."),
