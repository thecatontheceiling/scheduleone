...
public class SurfaceStorageEntity : SurfaceItem, IStorageEntity, IUsable
{
	...
	{
		return new StorageSurfaceItemData(base.GUID, base.ItemInstance, 0, base.ParentSurface.GUID.ToString(), RelativePosition, RelativeRotation, new ItemSet(StorageEntity.ItemSlots)).GetJson();
	}
	...
	public override void NetworkInitialize___Early()
	{
		if (!NetworkInitialize___EarlyScheduleOne_002EObjectScripts_002ESurfaceStorageEntityAssembly_002DCSharp_002Edll_Excuted)
		{
			...
			RegisterSyncVarRead(ReadSyncVar___ScheduleOne_002EObjectScripts_002ESurfaceStorageEntity);
		}
	}
